...
export const error = {
  ...
  create_ask_error: "주문 요청 정보가 올바르지 않습니다. 파라미터 값이 올바른지 확인해주세요.",
  create_bid_error: "주문 요청 정보가 올바르지 않습니다. 파라미터 값이 올바른지 확인해주세요.",
  ...
  validation_error: "잘못된 API 요청입니다. 누락된 파라미터가 없는지 확인해주세요.",
  invalid_query_payload: "올바르지 않는 서명입니다. AccessKey 또는 SecretKey가 올바른지 확인 후 이용해주세요.",
  jwt_verification: "올바르지 않는 서명입니다. AccessKey 또는 SecretKey가 올바른지 확인 후 이용해주세요.",
  expired_acess_key: "API Key가 만료되었습니다. 업비트 웹 > [MY] > [Open API 관리] > [Open API Key 관리] 페이지에서 재 발급 & 등록 후 진행해주세요.",
