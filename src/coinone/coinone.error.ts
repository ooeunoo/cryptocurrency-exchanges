...
export const error = {
  ...
  "Customers who need to register for API usage": "API 사용을 위한 등록이 필요합니다.",
  "This service is not approved": "승인되지 않은 서비스입니다.",
  "Invalid App Secret": "유효하지 않은 App Secret입니다. 코인원 웹 > Open API 메뉴에서 상태 확인 부탁드립니다.",
  "Invalid App Id": "유효하지 않은 APP ID입니다. 코인원 웹 > Open API 메뉴에서 상태 확인 부탁드립니다.",
  ...
  "Failed to refresh Access Token": "Access Token을 리프레쉬하는 데 실패했습니다.",
  "Invalid API permission": "승인되지 않은 API 권한입니다.",
  "You can use the API after complete Coinone identity verification by web or app": "코인원 웹이나 앱을 통한 KYC 인증 이후 API 이용이 가능합니다.",
  ...
  "V2 API Nonce value must be a positive integer": "V2 API Nonce 값은 양의 숫자 값이어야 합니다.",
  "V2 API Nonce is must be bigger then last nonce": "V2 API Nonce 값은 이전 Nonce 값보다 커야 합니다.",
  "Nonce already used": "이미 사용된 Nonce 값입니다.",
  "Nonce must be in the form of a UUID": "Nonce값은 UUID 포맷이어야 합니다.",
  "It's V2 API. V1 Access token is not acceptable": "V1의 Access Token으로는 V2 API 이용이 불가합니다.",
  "Invalid address": "유효하지 않은 주소입니다.",
  "The address is detected by FDS. Please contact our customer center": "FDS에 의해 제한된 주소입니다. 고객 센터로 연락 부탁드립니다.",
  "The address is not registered as an API withdrawal address": "API 출금 주소 등록이 필요한 주소입니다.",
  ...
  "Minimum withdrawal quantity insufficient": "최소 출금 가능 금액보다 부족합니다.",
  "Required the memo to proceed with the withdrawal": "출금을 위해서는 Memo 입력이 필요합니다.",
  "Withdrawal/Deposit id is invalid": "단일 입출금 내역 조회 시 올바르지 않은 입출금 내역 식별 ID가 입력된 경우입니다.",
  "price is required for LIMIT or STOP_LIMIT order": "지정가, 예약 지정가 주문시 필수정보인 가격필드가 입력되지 않은 경우입니다.",
  "qty is required for LIMIT or STOP_LIMIT or MARKET(SELL) order":
    "지정가, 예약 지정가, 시장가(매도), 주문시 필수정보인 수량필드가 입력되지 않은 경우입니다.",
  "post_only is required for LIMIT order": "지정가 주문시 필수정보인 post_only필드가 입력되지 않은 경우입니다.",
  "trigger_price is required for STOP_LIMIT order": "예약 지정가 주문시 필수정보인 trigger_price 필드가 입력되지 않은 경우입니다.",
  "amount is required for MARKET(BUY) order": "시장가(매수) 주문시 필수정보인 총액필드가 입력되지 않은 경우입니다.",
  "Not Supported Order Type": "지원하지 않는 주문 타입입니다.",
  "trigger price and current price can not be same": "예약지정가 주문시 trigger_price에 입력하신 값이 해당 코인의 현재가와 동일한 경우입니다.",
  "Withdrawal quantity is not correct": "옳바르지 않은 출금 수량입니다.",
  "Invalid order information": "유효하지 않은 주문 정보입니다.",
  "Cannot register selling orders below the base price": "기본가 이하로는 매도 주문 등록 불가합니다.",
  "Cannot register selling orders above the base price": "기본가격 이상으로는 매도 주문 등록 불가합니다.",
  "Cannot register buying orders below the base price": "기본가격 이하로는 매수 주문 등록 불가합니다.",
  "Cannot register buying orders above the base price": "기본가격 이상으로는 매수 주문 등록 불가합니다.",
  "Invalid quantity": "잘못된 수량이 입력되었습니다.",
  "Cannot be process the orders below the minimum amount": "최소 수량 이하로는 주문이 불가합니다.",
  "Cannot be process the orders exceed the maximum amount": "최대 수량 이상으로는 주문이 불가합니다.",
  ...
  "Invalid user_order_id (It must be lower case)": "잘못된 user_order_id (대문자 혹은 지원하지 않는 특문, 150자 초과)",
  "The API does not support a portfolio": "포트폴리오를 지원하지 않는 API입니다.",
  ...
  "Failed by 24-hour withdrawal delay policy": "원화 입금으로 인한 24시간 출금지연 상태로 출금에 실패했습니다.",
  "Try again after complete phone verification": "휴대폰 번호 인증 완료한 후에 다시 시도하십시오.",
  "An error in the balance. Please contact CS center": "잔고에 오류가 발생했습니다. 고객 센터에 연락하십시오.",
  "Account was detected through FDS system monitoring": "FDS 시스템 모니터링을 통해 계정이 감지되었습니다.",
  "Account is locked":
    "계정이 잠겨 있어 출금이 불가능한 상태입니다. 계정 잠금 해제는 최신 버전의 앱 또는 웹페이지에서 로그인하여 진행할 수 있습니다.",
  "Withdrawal is restricted by master account": "마스터 계정이 서브 계정의 가상자산 출금을 제한한 상태입니다.",
};
